...
for p = 1:length(dataname)
    ...
    DSMAddressBook = listing;  % Updated usage
    ...
    DHMAddressBook = listing;  % Updated usage
    ...
    for n = 1:NumRxPoints
        ...
        Features.CenterFreq(n) = DataPerOperator.dl_center_freq(n);
        %Features.CenterFreq(n) = Earfcn2Freq(DataPerOperator.earfcn(n));
